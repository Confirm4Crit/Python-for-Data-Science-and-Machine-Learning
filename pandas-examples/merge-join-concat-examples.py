...
# ## Concatenation
#
# Concatenation basically glues together DataFrames. Keep in mind that
# dimensions should match along the axis you are concatenating on.
# You can use **pd.concat** and pass in a list of DataFrames
...
# similar logic as merging SQL Tables together. For example:
